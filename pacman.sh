...
pacman -S --needed android-apktool android-ndk android-platform android-sdk android-sdk-build-tools android-sdk-cmdline-tools-latest android-sdk-platform-tools android-tools android-udev protobuf python-protobuf reflector-simple zoxide --noconfirm

#Install virtualbox
pacman -S --needed virtualbox-meta --noconfirm

#Install snapper
pacman -S --needed snapper snapper-support snap-pac-grub snap-pac btrfs-assistant --noconfirm
